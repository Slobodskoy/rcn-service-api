...
// Source: github.com/Slobodskoy/rcn-service-api/internal/app/repo (interfaces: EventRepo)
...
func (m *MockEventRepo) Add(arg0 []model.ServiceEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockEventRepo) Lock(arg0 uint64) ([]model.ServiceEvent, error) {
	m.ctrl.T.Helper()
